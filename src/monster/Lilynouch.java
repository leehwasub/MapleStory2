...
public final class Lilynouch extends Monster {
	...
	public Lilynouch() {
		super("릴리노흐", "lilynouch",
				new Strength(new Resistance(70, 170, 120, 120, 120, 120), 85, 3300000, 14000, 20, 20, 40, 40), 1354, 1380, 1400, 1432,
	...
	public void initSkillList() {
		skillList.add(new MonsterSkillInfor(0, 150, "방어력강화", strength.getMaxHp(), 20));
		...
		skillList.add(new MonsterSkillInfor(0, 1000, "블리자드", strength.getMaxHp(), 1));
