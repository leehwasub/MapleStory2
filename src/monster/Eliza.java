...
public final class Eliza extends Monster {
	...
	public Eliza() {
		super("엘리자", "eliza",
				new Strength(new Resistance(100, 100, 100, 100, 150, 50), 30, 37000, 6000, 20, 20, 30, 30), 270, 295, 301, 317,
	...
	public void initSkillList() {
		skillList.add(new MonsterSkillInfor(0, 150, "공격력강화", strength.getMaxHp(), 5));
