...
public final class Deo extends Monster {
	...
	public Deo() {
		super("데우", "deo",
				new Strength(new Resistance(170, 30, 100, 100, 100, 100), 45, 140000, 8000, 0, 0, 600, 600, 37, 37, 0), 564, 583, 583, 600,
	...
	public void initSkillList() {
		...
		skillList.add(new MonsterSkillInfor(400, 600, "여의선인", strength.getMaxHp(), 1));
