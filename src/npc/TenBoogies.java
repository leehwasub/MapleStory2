...
public class TenBoogies extends Npc{
	...
	public void requestQuest(Player player) {
		Quest quest = null;
		if(questNum == 0) {
			quest = Quest.makeQuest(1, 11, "우드마스크 조사").addMessage("페리온에서 유물 발굴단의 일원인 '열 마리의 부기를'만났다. 그녀는 최근 페리온 주변에서 마스크를 쓰고 다니는 이상한 몬스터가 발견 되고 있다고 한다.")
			...
			quest = Quest.makeQuest(1, 12, "유적 발굴 캠프장").addMessage("'열마리의 부기'는 우드마스크에서 발견된 물질에 대해서 유적 발굴 캠프단에게 알려야 한다고 한다.")
