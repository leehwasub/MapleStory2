	...
	public void requestQuest(Player player) {
		...
		if(questNum == 0) {
			quest = Quest.makeQuest(3, 15, "마가티아에 대한 정보").addMessage("마가티아에서 '한'이라는 자와 대화를 나누었다. 그는 마가티아에서 브로커로서 활동하고 있다고 한다.")
					.addMessage("그는 마가티아 주변 사막에서 출몰하는 스콜피온때문에 많은 사람들이 피해를 입고 있다며 스콜피온을 처리하고 금모래 가루를 가져와 주면")
					.addMessage("마가티아에 대한 정보를 알려주겠다고 한다. 세상에 공짜는 없는법. 스콜피온을 20마리 처리하고")
					.addMessage("금모래가루를 5개 구해가도록 하자. 금모래가루는 모래거인에게서 얻을 수 있다.").setRewardExp(10000).setRewardMoney(20000)
					.addRewardNpcQuestProceed("키니", 1).addQuestKill("스콜피온", 20).addQuestMaterial("금모래가루", 5)
