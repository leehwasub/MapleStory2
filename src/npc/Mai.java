	...
	public void requestQuest(Player player) {
		...
		if (this.questNum == 0) {
			quest = Quest.makeQuest(0, 2, "마이의 첫번쨰 수련").addMessage(
							...
							.addRewardUpdateMap("초보자의숲2", 3, 8, MapleMap.MAP_EMPTY_STATE)
							.addRewardUpdateMap("달팽이의숲", 6, 7, MapleMap.MAP_NPC_STATE)
							.addRewardUpdateNpc("달팽이의숲", 6, 7, "마이")
			...
			quest = Quest.makeQuest(0, 4, "마이의 두번째 수련").addMessage(
							...
							.addRewardUpdateMap("달팽이의숲", 14, 6, MapleMap.MAP_PORTAL_STATE);
			...
			quest = Quest.makeQuest(0, 5, "마이의 마지막 수련").addMessage(
							...
							.addRewardUpdateMap("달팽이의숲", 5, 14, MapleMap.MAP_PORTAL_STATE);
