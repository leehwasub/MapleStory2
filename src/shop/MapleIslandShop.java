...
public class MapleIslandShop extends Shop {
	public MapleIslandShop() {
		...
		this.weaponItemList.add(ItemPool.getItem("검", 1));
		this.weaponItemList.add(ItemPool.getItem("도루커대거", 1));
		this.equipmentItemList.add(ItemPool.getItem("하얀반팔면티(남)", 1));
		this.equipmentItemList.add(ItemPool.getItem("노란반팔면티(여)", 1));
		this.equipmentItemList.add(ItemPool.getItem("파란청반바지(남)", 1));
